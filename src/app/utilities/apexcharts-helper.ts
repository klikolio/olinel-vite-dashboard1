...
export const chartTextLevel: themeObjectLevel = {
	light: {
...
export const chartBgLevel: themeObjectLevel = {
	light: {
...
export const chartBorderColor: themeObject = {
	light: chartColorScheme.gray100,
	dark: chartColorScheme.gray700,
}

export const apexchartsNormalization = (extraOptions?: ApexOptions) => {
