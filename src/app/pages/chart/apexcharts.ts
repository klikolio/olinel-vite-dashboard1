...
const chart1Options = (series?: ApexAxisChartSeries) => {
...
const chart2Options = (series?: ApexAxisChartSeries) => {
	const extraOptions: ApexOptions = {}
	const themeVariant = getThemeVariant()
...
const chart3Options = (series?: ApexAxisChartSeries) => {
	const extraOptions: ApexOptions = {}
...
const chart4Options = (series?: ApexAxisChartSeries) => {
	const extraOptions: ApexOptions = {}
...
const chart5Options = (series?: ApexAxisChartSeries) => {
	const extraOptions: ApexOptions = {}
	const themeVariant = getThemeVariant()
...
const chart6Options = (series?: ApexAxisChartSeries) => {
	const extraOptions: ApexOptions = {}
...
const chart7Options = (series?: ApexAxisChartSeries) => {
	const extraOptions: ApexOptions = {}
...
const chart8Options = (series?: ApexNonAxisChartSeries) => {
	const extraOptions: ApexOptions = {}
...
const chart9Options = (series?: ApexAxisChartSeries) => {
	const extraOptions: ApexOptions = {}
	const themeVariant = getThemeVariant()
...
const chart10Options = (series?: ApexAxisChartSeries) => {
	const extraOptions: ApexOptions = {}
	const themeVariant = getThemeVariant()
...
pageLoadedListener(() => {
	...
	const chart5Instance = new ApexCharts(
		document.querySelector('#apexcharts-5'),
		chart5Options([
			{
				name: 'Website Blog',
				type: 'column',
	...
	const chart6Instance = new ApexCharts(
		document.querySelector('#apexcharts-6'),
		chart6Options([
			{
				data: [
					{
	...
	const chart7Instance = new ApexCharts(
		document.querySelector('#apexcharts-7'),
		chart7Options([
			{
				data: [
					{
	...
	const chart8Instance = new ApexCharts(
		document.querySelector('#apexcharts-8'),
		chart8Options([44, 55, 13, 43, 22]),
	)

	const chart9Instance = new ApexCharts(
		document.querySelector('#apexcharts-9'),
		chart9Options([
			{
				name: 'SAMPLE A',
				data: [
	...
	const chart10Instance = new ApexCharts(
		document.querySelector('#apexcharts-10'),
		chart10Options([
			{
				name: 'Series 1',
